...
class Employee extends CI_Controller
{
    ...
    public function save(){
        ...
        $data = [
            ...
            'empl_emergency_contact' => $this->input->post('empl_emergency_contact'),	 
            'empl_datebirth' => $this->input->post('empl_datebirth'),
            'empl_graduatefr' => $this->input->post('empl_graduatefr'),	
            'empl_graduatefr_magister' => $this->input->post('empl_graduatefr_magister'),	
            'empl_major' => $this->input->post('empl_major'),	
            'empl_major_magister' => $this->input->post('empl_major_magister'),
            ...
            'empl_isactive' => 1,	
            'empl_cv' => $cv,	 
            'empl_bankaccountname' => $this->input->post('empl_bankaccountname'),
            'empl_bankaccount' => $this->input->post('empl_bankaccount'),	
            'empl_nik' => $this->input->post('empl_nik'),	
            'empl_idcard' => $idcard,	
            'empl_npwp' => $this->input->post('empl_npwp'),	
            'empl_tax' => $tax,	
