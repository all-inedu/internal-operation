    ...
    <table id="myTable" class="display table table-striped table-bordered dt-responsive nowrap" style="width:100%">
        <thead>
            <tr>
                ...
                <th width="5%" class="text-center">Counselor Contact Person</th>
                <th width="5%" class="text-center">Principal Mail</th>
                <th width="5%" class="text-center">Mailing Address</th>
                <th width="5%" class="text-center">Phone Number</th>
                <th width="5%" class="text-center">Last Contact</th>
                <th width="5%" class="text-center">PIC</th>
                <th width="5%" class="text-center">Program Offered</th>
            </tr>
        </thead>
        <tbody>
            <?php for($i=1;$i<=25;$i++) { ?>
