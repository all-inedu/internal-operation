                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>idProgram</label>
                            <input name="idProgram" type="text" class="form-control form-control-sm"
                                placeholder="ID Program">
                            <?=form_error('idProgram', '<small class="text-danger">', '</small>');?>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>idProgram</label>
                            <input id="idProgram" name="idProgram" type="text" class="form-control form-control-sm"
                                placeholder="ID Program">
                            <?=form_error('idProgram', '<small class="text-danger">', '</small>');?>
                        </div>
                    </div>
