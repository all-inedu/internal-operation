            ...
            <div class="card-body">
                <div class="text-center">
                    ...
                    <div class="row text-center">
                        <div class="col">
                            <a href="<?=base_url('hr/editor/edit');?>" class="btn btn-sm btn-info m-1"><i
                                    class="fas fa-pencil-alt"></i>&nbsp; Edit</a>
                            <a href="<?=base_url('hr/editor/inactive');?>"
                                class="btn btn-sm btn-danger m-1 convert-button"
                                data-message="Incative this editor ?"><i class="fas fa-user-times"></i>&nbsp;
                                Inactive</a>
                        </div>
                    </div>
                </div>
