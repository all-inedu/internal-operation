                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6" style="cursor:pointer"
                            ...
                            <div class="card mb-3 shadow">
                                <div class="row no-gutters">
                                    <div class="col-md-12 bg-info text-white shadow align-middle">
                                        <div class="card-body">
                        ...
                        <div class="col-md-6" style="cursor:pointer"
                            ...
                            <div class="card mb-3 shadow">
                                <div class="row no-gutters">
                                    <div class="col-md-12 bg-warning text-dark shadow align-middle">
                                        <div class="card-body">
                                ...
                                <div class="row no-gutters">
                                    ...
                                    <div class="col-md-7 bg-secondary shadow my-auto pt-2 pb-2">
                                        <div class="card-body text-white">
                                            ...
                                            <h6>- Pending
                                                <div
                                                    class="float-right font-weight-bold badge badge-info pl-3 pr-3 shadow">
                                                    <?=$cpending;?>
                                                </div>
                                            </h6>
                                            <div class="line" style="margin-top:15px; margin-bottom:15px;"></div>
