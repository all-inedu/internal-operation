        ...
        <div class="col-md-7">
            <nav aria-label="breadcrumb" style="margin:7px -5px -10px -5px;">
                <ol class="breadcrumb bg-white shadow border">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Prospective Client</li>
                </ol>
            </nav>
        </div>
    </div>
...
<a href="<?=base_url('client/prospective/add/student/');?>" class="btn btn-sm btn-success ml-2 add"><i
        class="fas fa-plus-circle"></i>&nbsp; Add Prospective Client</a>
<div class="content">
    <table id="myTable" class="display table table-striped table-bordered dt-responsive nowrap" style="width:100%">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="cursor:pointer" onclick="window.location='<?=base_url('client/prospective/view');?>'">Rizka
                    Irawan
                </td>
